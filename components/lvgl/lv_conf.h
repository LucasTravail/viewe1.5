...
#define LV_FONT_CUSTOM_DECLARE LV_FONT_DECLARE(misans32) LV_FONT_DECLARE(misans20) LV_FONT_DECLARE(misans24)

/*Always set a default font*/
#define LV_FONT_DEFAULT &misans32
